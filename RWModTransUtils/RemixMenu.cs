...
namespace RWModTransUtils
{
    public class RemixMenu : OptionInterface
    {
        ...
        {
            disableFLabelIGT = config.Bind("RWModTransUtils_Bool_DisableFLabelIGT", false);
        ...
        public override void Initialize()
        {
            ...
            UIelement[] UIArrayElements = new UIelement[] 
            {
                ...
                new OpLabel(new Vector2(150f, 460f), new Vector2(300f, 30f), Custom.ReplaceLineDelimeters(OptionInterface.Translate("本mod强制给常见的文本元素添加了inGameTranslator.Translate()方法。<LINE>这能解决一些模组的硬编码文本无法被翻译的问题，<LINE>但可能会导致翻译冲突以及让本不该被翻译的文本也被翻译。<LINE>如果遇到这种情况，下面的选项或许可以帮到您？")), FLabelAlignment.Center, false, null),
                new OpCheckBox(disableFLabelIGT, 100, 375f),
                new OpLabel(140, 377f, OptionInterface.Translate("禁用FLabel强制翻译挂钩")),
                new OpLabel(140, 340f, Custom.ReplaceLineDelimeters(OptionInterface.Translate("没有使用翻译方法的Flabel类UI文本将不再被翻译，<LINE>可解决Bingo mode的菜单文本错位，但少量文本可能不被翻译。"))),
                new OpCheckBox(disableAllCustomIGT, 100, 275f),
                new OpLabel(140, 277f, OptionInterface.Translate("禁用所有强制翻译挂钩")),
                new OpLabel(140, 240f, Custom.ReplaceLineDelimeters(OptionInterface.Translate("一切没有使用翻译方法的文本将不再被翻译，<LINE>提供最大的兼容性，但会导致本模组提供的部分翻译无法显示。"))),
            };
